...
public class MoviBusController extends Controller{
    ...
    public Result read() {
        List<MoviBusVehiculo> movibuses = new Model.Finder(Ordering.String.class, MoviBusVehiculo.class).all();
    ...
    {
        JsonNode j = Controller.request().body().asJson();
        MoviBusVehiculo movi = new Model.Finder(Ordering.String.class, MoviBus.class).byId((j.findPath("id_vehiculo").asText()));
